 ...
 *
 * 生成策略
 * 0 | 时间(41位) | IDCenter (4位) | Biz ID(6位) | 序号(12位)
 */
public class IdWorker {
    ...
    private static final long IDCENTER_BIT =    4L;
    private static final long BIZ_BIT =         6L;
    ...
    public IdWorker(long startStmp, long idcenterid){
    ...
    public synchronized long nextId(long bizValue){
        if(bizValue > MAX_BIZ || bizValue < 0){
        ...
        return (currStmp - startStmp) << TIMESTMP_LEFT
